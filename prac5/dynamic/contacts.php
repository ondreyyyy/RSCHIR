...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($ui['contactsTitle'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></title>
    <link rel="stylesheet" href="/static/style.css">
</head>
<body data-theme="<?php echo htmlspecialchars($preferences['theme'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>">
    <h1><?php echo htmlspecialchars($ui['contactsTitle'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></h1>
    <p><?php echo htmlspecialchars($ui['contactsText'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></p>
    <nav>
